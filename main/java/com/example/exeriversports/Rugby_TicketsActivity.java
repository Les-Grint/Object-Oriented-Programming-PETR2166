...
public class Rugby_TicketsActivity extends AppCompatActivity {
    ...
    String TotPrc = "Total Price: £", CusTick = "Custom Rugby Ticket\n";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rugby_tickets);
        ...
        Buy_Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((A_T.equals(true) && (C_T.equals(false) && (M_T.equals(false) && (F_R.equals(false) && (M_R.equals(false) && (B_R.equals(false)))))))){
                    Toast.makeText(Rugby_TicketsActivity.this, "Select a Section", Toast.LENGTH_SHORT).show();
                }
                ...
                if ((A_T.equals(false) && (C_T.equals(false) && (M_T.equals(false) && (F_R.equals(true) && (M_R.equals(false) && (B_R.equals(false)))))))){
                    Toast.makeText(Rugby_TicketsActivity.this, "Select ticket type", Toast.LENGTH_SHORT).show();
                }
                ...
                if ((A_T.equals(false) && (C_T.equals(false) && (M_T.equals(false) && (F_R.equals(false) && (M_R.equals(false) && (B_R.equals(false) && (M_D.equals(true) || (V_P.equals(true) || (T_O.equals(true) )))))))))){
                    Toast.makeText(Rugby_TicketsActivity.this, "add on", Toast.LENGTH_SHORT).show();
                }
            }
        });
